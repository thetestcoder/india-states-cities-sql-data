...
-- Dumping database structure for iwa
CREATE DATABASE IF NOT EXISTS `iwa` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `iwa`;

-- Dumping structure for table iwa.cities
...
-- Dumping data for table iwa.cities: ~47,940 rows (approximately)
